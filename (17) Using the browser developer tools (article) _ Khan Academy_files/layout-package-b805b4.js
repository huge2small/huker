...
return babelHelpers.possibleConstructorReturn(this,e.apply(this,arguments))}r.prototype.render=function e(){return React.createElement("div",{className:css(styles.grow)})}
...
function r(){babelHelpers.classCallCheck(this,r)
return babelHelpers.possibleConstructorReturn(this,e.apply(this,arguments))}r.prototype.render=function e(){return React.createElement("div",{style:flexBasis(this.props.size)})}
return r}(React.Component)
...
i.setState({height:e.bottom-e.top})}},r),babelHelpers.possibleConstructorReturn(i,a)}t.prototype.componentDidMount=function e(){this.timers=[]
var t=setTimeout(this.updateHeight,16)
this.timers.push(t)}
t.prototype.componentDidUpdate=function e(t){if(this.props.children!==t.children){var r=setTimeout(this.updateHeight,16)
this.timers.push(r)}}
t.prototype.componentWillUnmount=function e(){this.timers.forEach(clearTimeout)}
t.prototype.render=function e(){var t=this
return React.createElement("div",{className:(0,_aphrodite.css)(styles.wrapper),style:{height:this.state.height}},React.createElement("div",{ref:function e(r){return t.measurer=r}},this.props.children))}
...
//# sourceMappingURL=/genfiles/compressed_js_packages_prod/en/layout-package.js.map 